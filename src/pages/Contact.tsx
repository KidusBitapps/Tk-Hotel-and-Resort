            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-yellow-600 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-gray-600">
                      <a href="tel:+251114300072" className="block font-bold hover:text-yellow-600 transition-colors">+251 114 300 072/73</a>
                      <a href="tel:+251906421111" className="block font-bold hover:text-yellow-600 transition-colors">+251 906 421 111</a>
                      <a href="tel:+251906511111" className="block font-bold hover:text-yellow-600 transition-colors">+251 906 511 111</a>
                    </div>
                  </div>
                </div>
